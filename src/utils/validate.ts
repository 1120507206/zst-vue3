...
//#region 表单验证相关
export function name(rule: FormItemRule, value: string, callback: ValidateCallback): void {
...
export function password(rule: FormItemRule, value: string, callback: ValidateCallback): void {
...
export function chineseName(rule: FormItemRule, value: string, callback: ValidateCallback): void {
...
export function region(rule: FormItemRule, value: string, callback: ValidateCallback): void {
...
export function email(rule: FormItemRule, value: string, callback: ValidateCallback): void {
...
export function fixedPhone(rule: FormItemRule, value: string, callback: ValidateCallback): void {
...
export function phone(rule: FormItemRule, value: string, callback: ValidateCallback): void {
...
export function postalCode(rule: FormItemRule, value: string, callback: ValidateCallback): void {
  if (!/^\d{6}$/.test(value)) {
...
export function idCard(rules: FormItemRule, value: string, callback: ValidateCallback): void {
  if (
...
export function idCardFormat(rules: FormItemRule, value: string, callback: ValidateCallback): void {
...
export function trim(rule: FormItemRule, value: string, callback: ValidateCallback): void {
...
export function positiveInt(rules: FormItemRule, value: string, callback: ValidateCallback): void {
